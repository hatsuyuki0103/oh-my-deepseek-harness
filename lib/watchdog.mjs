...
/**
 * 定位 hindsight daemon-start.js：配置 → 环境变量 → profile 默认路径，首命中返回。
...
export function resolveDaemonStartPath(overrides = {}) {
  ...
  candidates.push(
    join(dshHome, 'profiles', 'web', 'node_modules', '@vectorize-io', 'hindsight-coding-agents', 'dist', 'daemon-start.js')
  )
